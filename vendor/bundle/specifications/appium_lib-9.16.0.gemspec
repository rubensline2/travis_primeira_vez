# -*- encoding: utf-8 -*-
# stub: appium_lib 9.16.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<appium_lib_core>.freeze, ["~> 2.0"])
      s.add_runtime_dependency(%q<nokogiri>.freeze, ["~> 1.8", ">= 1.8.1"])
      s.add_runtime_dependency(%q<tomlrb>.freeze, ["~> 1.1"])
      s.add_development_dependency(%q<appium_thor>.freeze, ["~> 1.1", ">= 1.1.2"])
      ...
      s.add_dependency(%q<appium_lib_core>.freeze, ["~> 2.0"])
      s.add_dependency(%q<nokogiri>.freeze, ["~> 1.8", ">= 1.8.1"])
      s.add_dependency(%q<tomlrb>.freeze, ["~> 1.1"])
      s.add_dependency(%q<appium_thor>.freeze, ["~> 1.1", ">= 1.1.2"])
